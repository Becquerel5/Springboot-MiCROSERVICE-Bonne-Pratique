...
import net.dt.paiement.mapper.ModePaiementMapper;
import net.dt.paiement.openfeign.CustomerRestClient;
import net.dt.paiement.repository.ModepaimentRepossitory;
